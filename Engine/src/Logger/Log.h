...
namespace Rapture {
	...
	public:
		...
		static std::shared_ptr<spdlog::logger>& GetDebugLogger() { return s_DebugLogger; }
...
// Debug log macros
#define GE_DEBUG_TRACE(...)   Log::GetDebugLogger()->trace(__VA_ARGS__)
#define GE_DEBUG_INFO(...)    Log::GetDebugLogger()->info(__VA_ARGS__)
#define GE_DEBUG_WARN(...)    Log::GetDebugLogger()->warn(__VA_ARGS__)
#define GE_DEBUG_ERROR(...)   Log::GetDebugLogger()->error(__VA_ARGS__)
#define GE_DEBUG_FATAL(...)   Log::GetDebugLogger()->critical(__VA_ARGS__)

// Render log macros
#define GE_RENDER_TRACE(...)  Log::GetRenderLogger()->trace(__VA_ARGS__)
#define GE_RENDER_INFO(...)   Log::GetRenderLogger()->info(__VA_ARGS__)
#define GE_RENDER_WARN(...)   Log::GetRenderLogger()->warn(__VA_ARGS__)
#define GE_RENDER_ERROR(...)  Log::GetRenderLogger()->error(__VA_ARGS__)
#define GE_RENDER_FATAL(...)  Log::GetRenderLogger()->critical(__VA_ARGS__)

// Physics log macros
#define GE_PHYSICS_TRACE(...) Log::GetPhysicsLogger()->trace(__VA_ARGS__)
#define GE_PHYSICS_INFO(...)  Log::GetPhysicsLogger()->info(__VA_ARGS__)
#define GE_PHYSICS_WARN(...)  Log::GetPhysicsLogger()->warn(__VA_ARGS__)
#define GE_PHYSICS_ERROR(...) Log::GetPhysicsLogger()->error(__VA_ARGS__)
#define GE_PHYSICS_FATAL(...) Log::GetPhysicsLogger()->critical(__VA_ARGS__)

// Audio log macros
#define GE_AUDIO_TRACE(...)   Log::GetAudioLogger()->trace(__VA_ARGS__)
#define GE_AUDIO_INFO(...)    Log::GetAudioLogger()->info(__VA_ARGS__)
#define GE_AUDIO_WARN(...)    Log::GetAudioLogger()->warn(__VA_ARGS__)
#define GE_AUDIO_ERROR(...)   Log::GetAudioLogger()->error(__VA_ARGS__)
#define GE_AUDIO_FATAL(...)   Log::GetAudioLogger()->critical(__VA_ARGS__)