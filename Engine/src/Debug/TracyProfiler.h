...
// Include Tracy when enabled
    ...
    // Include OpenGL headers before Tracy's OpenGL integration
    #include <glad/glad.h>
...
// Legacy profiling toggle for backward compatibility
...
// Define profiling macros based on Tracy availability
    ...
    #define RAPTURE_PROFILE_GPU_SCOPE(name) \
        TracyGpuNamedZone(gpu_scope##__LINE__, name, true)
